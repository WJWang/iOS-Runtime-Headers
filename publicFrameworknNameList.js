const PRIVATE_FRAMEWORKS_PATH = __dirname + '/Frameworks/';
...
recursive(PRIVATE_FRAMEWORKS_PATH, function(err, frameworkDirNameList) {
  if(err) {
    ...
    gracefulFs.writeFile(__dirname+'/src/json/PublicFrameworksNameList/PublicFrameworksNameList.json', JSON.stringify(frameworkDirNameList, null, 2), 'utf8', function(err) {
